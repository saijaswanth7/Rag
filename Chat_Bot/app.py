# NOTE: Run this app using: streamlit run app.py
...
# Try to get API key from Streamlit secrets, fallback to .env
...
if not groq_api_key:
    st.error("❌ Missing GROQ_API_KEY. Set it in .streamlit/secrets.toml or in a local .env file.")
    st.stop()
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as tmp_file:
        ...
        if user_query:
            ...
            if "not related" in validated.lower():
                ...
                st.session_state.chat_history.append(("assistant", "This question is not related to the document."))
